...
export default function Home() {
  ...
  return (
    <>
      ...
      <div className="min-h-screen w-full bg-black flex flex-col items-center pt-20 text-white select-none">
        <div className="flex gap-4 mb-10">
          ...
          <button
            onClick={() => setLoop((v) => !v)}
            className={`px-6 py-2 rounded-full font-medium transition-all duration-200 ${
              loop ? "bg-[#7C3AED] text-white" : "bg-white text-black"
            }`}
          >
            Loop
          </button>
          ...
          <div className="flex flex-col items-center gap-6 pr-6">
            <div className="flex flex-row items-center gap-6">
              ...
              <button
                ...
                className="w-16 h-16 bg-[#7C3AED] rounded-full flex items-center justify-center"
              >
                {isRunning ? (
